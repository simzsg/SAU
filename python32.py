# สร้างโปรแกรมเครื่องคำนวณของตัวเลข 2 จำนวน ที่รับทางแป้นพิมพ์ ได้แก่ บวก ลบ คูณ หาร โดยทำเป็นเมนูให้ผู้ใช้เลือก ผู้ใช้เลือกเมนูไหนให้คำนวณตามเมนูนั้นๆ แล้วเสดงผลลัพธ์
